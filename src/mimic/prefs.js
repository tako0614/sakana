...
export const ENGINES = {
  ...
  // 5.2 と 5.3 は**段1 が同じ**なので、違いは「なりきりの学習量と勾配」だけ。
  // 指名した人らしさの実測 (本人のトークンの方が本物の発言を当てられる割合):
  //   evex-5.2  下位 65.6%      evex-5.3  下位 68.0%
  'evex-5.3': {
    label: 'evex-5.3',
    summary: '指名した人らしさをさらに強めた版。1人あたりの学習量を約3倍にして、切り出しの中で「その人の発言」だけを学ぶようにしてある。話題の噛み合いは 5.2 より控えめ'
  },
  'evex-5.2': {
    label: 'evex-5.2',
  ...
  'evex-4.1': {
    label: 'evex-4.1',
    summary: 'evex-4 と同じ大きさで、このサーバーのぶんをさらに厚くしたもの。話題の噛み合いは evex-4 に劣るが、学習データに寄っているぶん言い回しがこのサーバーらしい。読み比べ用に並べてある'
  },
  'evex-4': {
    label: 'evex-4',
    summary: 'evex-3.5 と同じ大きさで、学習データを 7.7 倍にしたもの。なりきり掲示板に加えて映画字幕とネット掲示板の雑談で土台を作り、外部の会話も Discord の粒度 (連投・返信) に直してある。リアクションの付いた発言とチャンネルも初めて使っている'
  },
  // evex だけで仕上げたもの。evex-3 と読み比べるために並べる
  'evex-3.5': {
    label: 'evex-3.5',
