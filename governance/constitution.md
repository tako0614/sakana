...
1. 立法は、定期的に開かれる国会において行う。開会の間隔は、実行規則が定める上限を超えてはならない。
...
10. 開会間隔の上限、合議の席数と必要票、継続審議の上限、投票範囲、定足数および成立条件は、本憲法末尾の実行規則で定める。
