...
9. 調査の手数および1回の審議で受け取れる調査結果の総量は、実行規則が定める上限を超えてはならない。上限に達したときは、その時点までに得た記録だけで判断する。
