...
8. 各席が用いた調査手段、その回数および引用した記録は、実行規則が定める粒度で公開し、完全な記録を監査可能な形で保存しなければならない。
